...
public class Utility {
  ...
  public static String paging(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
    ...
    if (nowGrp >= 2) {
      str.append("<li><a href='./list?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'><i class=\"fa-solid fa-angle-left\"></i></a></li>");
    }
    ...
    if (nowGrp < totalGrp) {
      str.append("<li><a href='./list?col=" + col + "&word=" + word + "&nowPage=" + _nowPage + "'><i class=\"fa-solid fa-angle-right\"></i></a></li>");
    }
    str.append("</div>");
//    str.append("</div>");
  ...
  public static String rpaging(int total, int nowPage, int
      recordPerPage, String col, String word, String url, int nPage) {
