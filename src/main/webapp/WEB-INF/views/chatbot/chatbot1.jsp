            ...
            <div class="content">
                <div class="chat_head_content con">
                    ...
                    <div class="chat_img" size="30">
                        <img width="30" height="30" src="https://user-images.githubusercontent.com/103401972/178628320-ea1e1a62-606d-48f6-aaf2-c590056d6edb.jpg">
                    </div>
                    <span class="chat_head Text">
                        <img width="200" height="45"  src="https://user-images.githubusercontent.com/103401972/178628317-aa8929f4-c207-4791-b82b-df8480644da6.png">
                    </span>
                </div>
                </div>
                <div class="head_right">
                    <button class="back" onclick="location.href='http://localhost:8000'">
            ...
            <div class="Content-ch-front maintool" id="conversation">
                     <div class="Content-ch-front imgtexttool" >
                        <div class="Content-ch-front imges" size="36">
                            <img width="36" height="36" src="https://user-images.githubusercontent.com/103401972/178628320-ea1e1a62-606d-48f6-aaf2-c590056d6edb.jpg">
                        </div>
